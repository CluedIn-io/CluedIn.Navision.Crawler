...
namespace CluedIn.Crawling.Navision.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<INavisionClientFactory>().AsFactory())
                .Register(Component.For<NavisionClient>().LifestyleTransient());
