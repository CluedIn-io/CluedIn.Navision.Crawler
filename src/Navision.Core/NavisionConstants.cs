...
namespace CluedIn.Crawling.Navision.Core
{
    public class NavisionConstants
    {
        ...
        public const string CrawlerDescription = "Navision is a ... to be completed ...";
        ...
        // src\Navision.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "Navision";
        public const string ProviderRootCodeValue = "Navision";
        public const string CrawlerName = "NavisionCrawler";
        public const string CrawlerComponentName = "NavisionCrawler";
        public static readonly Guid ProviderId = Guid.Parse("432d4f25-b264-49b2-b5eb-9c46f7cf06ab");
        public const string ProviderName = "Navision";
