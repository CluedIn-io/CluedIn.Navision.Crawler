...
{
    public class Navision_Command_MeshProcessor : BaseMeshProcessor
    {
        public Navision_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          NavisionConstants.ProviderId;
