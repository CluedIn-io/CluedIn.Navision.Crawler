...
{
    public class DataIngestion : IClassFixture<NavisionTestFixture>
    {
        private readonly NavisionTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(NavisionTestFixture fixture, ITestOutputHelper output)
        {
